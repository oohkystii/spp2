...
class ProcessTagihanLainStore implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if (count($numbersHPWali) > 0) {
            ...
            $result =  $wa->sendSchedulesMessage($numbersHPWali, $dataSiswa, $requestData['tanggal_tagihan'], $requestData['tanggal_tagihan'], $tagihan->id, $requestData['tanggal_jatuh_tempo'], $itemBiaya->nama);
        }
