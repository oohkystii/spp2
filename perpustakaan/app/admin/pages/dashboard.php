...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMK WOW</h2>
            <p class="text-center">Alamat : Jl.Mayor Syamsu No.1, Jayaraga, Kec. Tarogong Kidul, Jawa Barat</p>
