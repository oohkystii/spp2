<!DOCTYPE html>
  ...
  <head>
    ...
    <title> {{ @$title != '' ? "$title |" : '' }} {{ settings()->get('app_name', 'SPP') }}</title>
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ \Route::is('operator.beranda') ? 'active' : '' }}">
              <a href="{{ route('operator.beranda') }}" class="menu-link nav-link">
            ...
            {{-- <li class="menu-item {{ \Route::is('kirimpesan.*') ? 'active' : '' }}">
              <a href="{{ route('kirimpesan.create') }}" class="menu-link nav-link">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div data-i18n="Basic">Kirim Pesan</div>
              </a>
            </li> --}}
            <!-- Data User -->
            <li class="menu-item {{ \Route::is('user.*') ? 'active' : '' }}">
              <a href="{{ route('user.index') }}" class="menu-link nav-link">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div data-i18n="Basic">Data Operator</div>
              </a>
            </li>
            <!-- Data Aktivitas User -->
            {{-- <li class="menu-item {{ \Route::is('logactivity.*') ? 'active' : '' }}">
              <a href="{{ route('logactivity.index') }}" class="menu-link nav-link">
                <i class="menu-icon tf-icons bx bx-user"></i>
            ...
            <li class="menu-item {{ \Route::is('wali.*') ? 'active' : '' }}">
              <a href="{{ route('wali.index') }}" class="menu-link nav-link">
                <i class="menu-icon tf-icons bx bx-user-plus"></i>
                <div data-i18n="Basic">Data Orang Tua Siswa</div>
              </a>
            </li>
             <!-- Data Siswa -->
             <li class="menu-item {{ \Route::is('siswa.*') ? 'active' : '' }}">
              <a href="{{ route('siswa.index') }}" class="menu-link nav-link">
            ...
            <li class="menu-item {{ \Route::is('biaya.*') ? 'active' : '' }}">
              <a href="{{ route('biaya.index') }}" class="menu-link nav-link">
            ...
            <li class="menu-item {{ \Route::is('jobstatus.*') ? 'active' : '' }}">
              <a href="{{ route('jobstatus.index') }}" class="menu-link nav-link">
             ...
             <li class="menu-item {{ \Route::is('tagihan.*') ? 'active' : '' }}">
              <a href="{{ route('tagihan.index') }}" class="menu-link nav-link">
            ...
            <li class="menu-item {{ \Route::is('pembayaran.*') ? 'active' : '' }}">
              <a href="{{ route('pembayaran.index') }}" class="menu-link nav-link">
            ...
            <li class="menu-item {{ \Route::is('laporan.*') ? 'active' : '' }}">
              <a href="{{ route('laporanform.create') }}" class="menu-link nav-link">
    ...
    @stack('scripts')
    <script>
      $("#alert-messages").not('.alert-important').delay(2000).fadeOut(350);
    </script>
  </body>
</html>