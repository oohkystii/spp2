                ...
                <div class="col-sm-7">
                    <div class="card-body">
                        ...
                        <p class="mb-4">
                            ...
                            notifikasi yang belum dilihat. Klik tombol di bawah untuk melihat informasi pembayaran.
                        </p>
                        ...
                        <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                    <a class="dropdown-item" href="{{ route('pembayaran.index') }}">Lihat lebih lengkap</a>
                                </div>
                            </div>
                        </div>
...
<script src="{{ $jenisTagihanChart->cdn() }}"></script>
